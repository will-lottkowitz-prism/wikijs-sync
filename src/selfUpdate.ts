// GENERATED from scripts/selfUpdate.ts by `npm run sync-shared` — do not edit here.
// ============================================================================
// Self-updater — shared across all three xQx extensions.
//
// CANONICAL COPY: scripts/selfUpdate.ts
// Generated copies:  <extension>/src/selfUpdate.ts  (do not edit those)
// Run `npm run sync-shared` after changing this file; CI enforces they match.
//
